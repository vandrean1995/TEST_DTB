  ...
  <div class="portlet light bordered">
    <div class="portlet-title">
      <div class="caption font-dark">
        ...
        <span class="caption-subject bold uppercase">Usergroup list</span>
      </div>
    </div>
        ...
        @foreach( $usergroup as $data )
          <tr class="odd gradeX">
            ...
            @if( $role->group->u == true )
              <a href="{{ route('uacl.group.update', \Crypt::encrypt( $data->id )) }}" class="btn btn-warning btn-md spawnModal" data-toggle="modal" data-target="#updateModal">Update</a>
            @endif
            @if( $role->group->d == true )
              <a href="{{ route('uacl.group.delete', \Crypt::encrypt( $data->id )) }}" class="btn btn-danger btn-md spawnModal" data-toggle="modal" data-target="#deleteModal">Delete</a>
            @endif
            </td>
          </tr>
          @endforeach
